...
# Construir el autoencoder convolucional para la comparación
...
normalized_data = normalized_data.reshape(-1, LONGITUD_SERIE, 1)
...
denormalized_data = scaler.inverse_transform(reconstructed_data.reshape(-1, LONGITUD_SERIE))
